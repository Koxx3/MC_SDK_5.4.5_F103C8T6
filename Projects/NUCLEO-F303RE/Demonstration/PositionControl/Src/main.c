...
/* User define Position Control input parameters */

// Demo mode parameters
#define TARGET_POS_LEN     2                  /* Number of desired position(s) set for demo */
#define NB_ROTATION        10                 /* Set nb turns for demo */ 
#define ANGLESTEP          (2.0f * M_PI * NB_ROTATION) /* Unitary step defined for demo in Radiant */
#define MOVE_DURATION      0.36f               /* Desired time duration allowed to reach the final position  (in seconds) */
#define HOLD_TIME          0.36f
/* USER CODE END PD */
...
/* Private user code ---------------------------------------------------------*/
/* USER CODE BEGIN 0 */
float MovementDuration = MOVE_DURATION;
/* Table to set desired position(s) - infinite cyclic loop for demo */
float TargetPositionSequence[] = {ANGLESTEP, 0.0f};  
uint8_t TargetPosIndex = 0;
demoMode_t demoMode = DEMO_TRAJECTORY_CONTROL;
