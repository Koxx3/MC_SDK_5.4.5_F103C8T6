...
static void MX_COMP3_Init(void)
{
  ...
  hcomp3.Init.Output = COMP_OUTPUT_TIM1BKIN2;
...
static void MX_COMP4_Init(void)
{
  ...
  hcomp4.Init.Output = COMP_OUTPUT_TIM8BKIN2;
...
static void MX_COMP5_Init(void)
{
  ...
  hcomp5.Init.Output = COMP_OUTPUT_TIM8BKIN2;
...
static void MX_COMP6_Init(void)
{
  ...
  hcomp6.Init.Output = COMP_OUTPUT_TIM8BKIN2;
