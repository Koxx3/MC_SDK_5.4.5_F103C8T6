...
typedef struct
{
  /* First OPAMP settings ------------------------------------------------------*/
   ...
   uint32_t OPAMPConfig1 [6]; /*!< Define the OPAMP_CSR_VPSEL config for each ADC conversions*/ 
   uint32_t OPAMPConfig2 [6]; /*!< Define the OPAMP_CSR_VPSEL config for each ADC conversions*/ 
