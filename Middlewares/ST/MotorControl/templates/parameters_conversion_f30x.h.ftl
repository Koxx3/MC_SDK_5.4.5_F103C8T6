...
#define ADV_TIM_CLK_MHz2  ${(ADV_TIM_CLKFreq2/1000000)?floor}
...
<#if MC.DUALDRIVE == true>
<#if MC.HIGH_SIDE_IDLE_STATE2 != false>
#error "Error: HIGH_SIDE_IDLE_STATE2 in driver_parameters.h must be false (TURN_OFF)."
</#if>
</#if>
...
<#if MC.DUALDRIVE == true>
<#if MC.LOW_SIDE_IDLE_STATE2 != false>
#error "Error: LOW_SIDE_IDLE_STATE2 in driver_parameters.h must be false (TURN_OFF)."
</#if>
</#if>
