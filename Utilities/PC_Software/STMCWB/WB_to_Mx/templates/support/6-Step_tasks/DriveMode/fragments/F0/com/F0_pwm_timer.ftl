...
<#function cs_TIMER_settings motor get_parameter use_aux_tim=true>
...
<#function cs_AUX_TIMER_settings motor>
    ...
    <#local aux_settings_parameters =
        { meta.no_chk("Period") : "((PWM_PERIOD_CYCLES) - 1)"
                                            <#--Formula TIM3 or TIM15 TIMxx.Period = (TIM1.Period * 2)-1 -->
...
<#import "../../../../../MC_task/utils/user_constants.ftl" as mcu>
    ...
    <#local _define_HF_TIMX_ARR = mcu.define("HF_TIMX_ARR", "(SYSCLOCK_FREQUENCY/(GATE_DRIVING_PWM_FREQUENCY*(HF_TIMX_PSC+1))-1)" )>
    <#local _define_HF_TIMX_PSC = mcu.define("HF_TIMX_PSC", "11" )>

    <#local parameters =
    { meta.comment_key()               : "Counter Settings"
    , meta.no_chk("Prescaler")         : "HF_TIMX_PSC"
    , "CounterMode"                    : "TIM_COUNTERMODE_UP"
    , meta.no_chk("Period")            : "HF_TIMX_ARR"
    , "ClockDivision"                  : "TIM_CLOCKDIVISION_DIV1"
    , meta.no_chk("RepetitionCounter") : "0"
    ,"AutoReloadPreload"               : "TIM_AUTORELOAD_PRELOAD_DISABLE"

    ,meta.comment_key()                : "Trigger Output (TRGO) Paramiters"
    , "TIM_MasterSlaveMode"            : "TIM_MASTERSLAVEMODE_ENABLE"
     ,"TIM_MasterOutputTrigger"        : "TIM_TRGO_OC4REF"


    , meta.comment_key() : "BRK Configuration"
    ...
    , meta.comment_key()      : "BRK Output Configuration"
    ...
    , meta.no_chk("DeadTime") : "0"

    ,  meta.comment_key()             : "Mode==Use ETR as Clearing Source => Config the Clear Input"
    , "ClearInputSource"              : "TIM_CLEARINPUTSOURCE_ETR"
    , "ClearInputPolarity"            : "TIM_CLEARINPUTPOLARITY_NONINVERTED"
    , "ClearInputPrescaler"           : "TIM_CLEARINPUTPRESCALER_DIV1"
    , meta.no_chk("ClearInputFilter") : "8"
    , "ClearChannel1"                 : "TIM_CHANNEL_1"
    , "ClearChannel2"                 : "TIM_CHANNEL_2"
    , "ClearChannel3"                 : "TIM_CHANNEL_3"
    ...
    , "OCIdleState_4" : "TIM_OCIDLESTATE_RESET" <#--${ utils.polarity(timer.HIGH_SIDE_IDLE_STATE, timer.PHASE_WH_POLARITY) }"-->
    ...
    , meta.no_chk("Pulse-PWM\\ Generation1\\ CH1"        ) :  "0"
    , meta.no_chk("Pulse-PWM\\ Generation2\\ CH2"        ) :  "0"
    , meta.no_chk("Pulse-PWM\\ Generation3\\ CH3"        ) :  "0"
    , meta.no_chk("Pulse-PWM\\ Generation4\\ No\\ Output") :  "0"
    ...
    <#local extra_OCMode_Generation_x_No_Output = fp.map_ctx(timer, OCMode_Generation_x_No_Output, no_outs) >
        ...
        <#return fp.foldl(fp.concat, parameters, PWM_Generation_xs + extra_PWM_Generation_x_No_Output )
           + meta.blankLn("")
           + meta.blankLn("")
           + fp.foldl(fp.concat, parameters, OCMode_Generation_xs + extra_OCMode_Generation_x_No_Output )
           >
