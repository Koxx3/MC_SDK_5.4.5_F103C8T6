...
-->
    ...
    <#if WB_SERIAL_COMMUNICATION >
        ...
        <#if cr.use_Cortex()>
            ...
            <@ns_cortex_ip.collectCortexIP ip/>
        </#if>
...
<#function serial_gpio ip ch full=true>
    ...
    <#local attr = cr.cortexPinAttribute(pin)>


    <#return
        [ "# ${ch}"
        , "${pin}.GPIOParameters=GPIO_Speed,GPIO_PuPd,GPIO_Label,GPIO_Mode${defaultOD}${attr.cortexLabel}"
