<#if ! __PARAMETERS_CONVERSION_G4XX_H??>
    <#assign __PARAMETERS_CONVERSION_G4XX_H></#assign>

    <#import "../../names_map.ftl" as rr>
    <#assign ADC_PIN_MODE_SUFFIX= "-Single-Ended" in rr>
    <#assign ADC_SAMPLETIME_SUFFIX= "_5" in rr>

    <#assign ADC_CLOCK_SYNC_PCLK_DIV = "ADC_CLOCK_ASYNC_DIV" in rr>

    <#assign DAC_Trigger_key_suffix      = "_OUT1"     in rr>


    <#assign ITR_TIMx = { "TIM4" : "ITR3"
                        , "TIM2" : "ITR1"
                        , "TIM3" : "ITR2"
                        } in rr >


    <#assign ADC_IRQs = { "ADC1" : "ADC1_2"
                         , "ADC2" : "ADC1_2"
                         , "ADC3" : "ADC3"
                         , "ADC4" : "ADC4"
                         } in rr >
    ...
    <#if rtos.has_rtos()>
        <#assign SET_IRQ_ADC = (WB_RTOS_USE_IRQ!false)?then([true, 7, 0, true, true, false, true,  true]
