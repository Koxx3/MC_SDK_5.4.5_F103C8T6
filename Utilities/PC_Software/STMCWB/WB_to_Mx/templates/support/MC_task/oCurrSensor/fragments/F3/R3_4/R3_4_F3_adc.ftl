...
-->
    <#local adc1_gpios = register_ADC_and_generatePinDefinition(adc1, adc1_cnvs, timer, internal_opamps, "3Sh")
            adc2_gpios = register_ADC_and_generatePinDefinition(adc2, adc2_cnvs, timer, internal_opamps, "3Sh") >
