...
<#macro R1_x_F7_all_settings motor device sense>
...
<#macro curr_sense_OCP motor>
    <#import "../com/F7_ocp.ftl" as ns_ocp >
    <#local config = ns_ocp.cs_over_current_prot(motor, [""]) >
    <@cmn_sets.curr_sense_OCP config />
</#macro>

<#macro curr_sense_TIMER motor>
    <#import "../com/F7_pwm_timer.ftl" as cmns_tmr>
    <#import "R1_x_F7_pwm_timer.ftl" as tmr >
...
<#function extra_TIM_UP_IRQ_settings timer config>
    ...
    <#if irq_name?has_content >
        ...
        + { "Extra ${timer.name}_UP IRQ (Required in conf: F7 R3_1 )" : tim_up_IRQ }>
...
-->
    <#local table = {"TIM1" : [ {"dma_request": "TIM1_CH4/TRIG/COM", "channel": "DMA2_Stream4", "priority": "VERY_HIGH" } + dma_req_extra_fields(0)
                              , {"dma_request": "TIM1_UP"          , "channel": "DMA2_Stream5", "priority": "VERY_HIGH" } + dma_req_extra_fields(1)
                              ]
                    ,"TIM8" : [ {"dma_request": "TIM8_CH4/TRIG/COM", "channel": "DMA2_Stream7", "priority": "VERY_HIGH" } + dma_req_extra_fields(0)
                              , {"dma_request": "TIM8_UP"          , "channel": "DMA2_Stream1", "priority": "VERY_HIGH" } + dma_req_extra_fields(1)
                              ]
                    }>
...
<#macro curr_sense_OPAMP_and_ADC motor>
    <#import "R1_x_F7_opamp.ftl" as op >
...
<#macro curr_sense_ADC motor internal_opamp=false>
    <#import "R1_x_F7_adc.ftl" as ns_adc >
