...
<#macro G0_R3_1_all_settings motor device sense>
...
<#macro curr_sense_TIMER motor>
    ...
    <#import "G0_R3_1_pwm_timer.ftl" as tmr >
...
<#macro curr_sense_ADC motor>
    <#import "G0_R3_1_adc.ftl" as ns_adc >
...
<#macro curr_sense_DMA>
    ...
    <#local single_request_for_ADC = {"dma_request": "ADC1", "channel": "DMA1_Channel1", "direction": "DMA_PERIPH_TO_MEMORY", "priority": "HIGH", "irq_priority": "1"} >
    <@ui.boxed "DMA" '~' >
