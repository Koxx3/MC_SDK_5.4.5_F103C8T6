...
-->
    ...
    <#--<#local _define_period = mcu.define("PWM_PERIOD_CYCLES" , timer.PWM_PERIOD_CYCLES?floor)>-->
    <#--<#local _define_PWM_PERIOD_MINUS_1  = mcu.define("PWM_PERIOD_MINUS_1", "((PWM_PERIOD_CYCLES) - 1)" )>-->
