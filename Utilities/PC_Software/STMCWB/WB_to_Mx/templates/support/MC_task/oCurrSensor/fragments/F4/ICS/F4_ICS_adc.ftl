...
<#function get_settings motor >
    ...
    <#local opt_extras_reg_conv_1 = ex.add_extra_regular_cnv_if_needed(adc1, cnv_U)
            opt_extras_reg_conv_2 = ex.add_extra_regular_cnv_if_needed(adc2, cnv_V) >

    <#local gpios_U = ap.register_ADC_and_generatePinDefinition(adc1, [cnv_U], timer_idx, "ICS")
            gpios_V = ap.register_ADC_and_generatePinDefinition(adc2, [cnv_V], timer_idx, "ICS") >
