...
<#macro R1_x_H7_all_settings motor device sense>
...
<#macro curr_sense_OCP motor>
    <#import "../com/H7_ocp.ftl" as ns_ocp >
    <#local config = ns_ocp.cs_over_current_prot(motor, [""]) >
    <@cmn_sets.curr_sense_OCP config />
</#macro>

<#macro curr_sense_TIMER motor>
    <#import "../com/H7_pwm_timer.ftl" as cmns_tmr>
    <#import "R1_x_H7_pwm_timer.ftl" as tmr >
...
<#--Add the Cortex config for IP - Call the Macro  CortexMx-->
    ...
    <@ns_cortex_ip.collectCortexIP pwm_timer/>
...
-->
    <#local table = {"TIM1" : [ {"dma_request": "TIM1_CH4", "channel": "DMA1_Stream0"  } + dma_req_extra_fields(0) ]
                    ,"TIM8" : [ {"dma_request": "TIM8_CH4", "channel": "DMA1_Stream0"  } + dma_req_extra_fields(0) ]
                    }>
...
<#macro curr_sense_OPAMP_and_ADC motor>
    <#import "R1_x_H7_opamp.ftl" as op >
...
<#macro curr_sense_ADC motor internal_opamp=false>
    <#import "R1_x_H7_adc.ftl" as ns_adc >
