...
<#import "../com/H7_opamp.ftl" as cmns_op>
...
<#function cs_OPAMPs_settings motor>
    ...
    <#list [{"opamp":opamp1, "phase": "U"}, {"opamp":opamp2, "phase": "V"}] as item>
        ...
        <#--Add the Cortex config for IP - Call the Macro  CortexMx-->
            ...
            <@ns_cortex_ip.collectCortexIP store_opamp_name/>
            ...
            <#if item.phase == "V" && ! sensing?contains("ICS") >
