...
<#macro R3_4_G4_all_settings motor device sense>
...
<#macro curr_sense_TIMER motor>
    ...
    <#import "../R3_1/R3_1_G4_pwm_timer.ftl" as tmr >
...
<#function extra_TIM_UP_IRQ_settings timer config>
    ...
    <#if irq_name?has_content >
        ...
        + { "Extra ${timer.name}_UP IRQ (Required in conf: G4 R3_4 )" : tim_up_IRQ }>
