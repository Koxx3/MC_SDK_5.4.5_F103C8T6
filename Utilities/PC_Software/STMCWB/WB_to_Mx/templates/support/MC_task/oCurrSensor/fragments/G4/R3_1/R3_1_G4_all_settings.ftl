...
<#macro R3_1_G4_all_settings motor device sense>
...
<#macro curr_sense_TIMER motor>
    ...
    <#import "R3_1_G4_pwm_timer.ftl" as tmr >
...
<#function extra_TIM_UP_IRQ_settings timer config>
    ...
    <#--<#local tim_up_IRQ = ns_ip.ip_irq( irq_name, [true, 0,0,false, false, false, true]) >-->
        ...
        + { "Extra ${timer.name}_UP IRQ (Required in conf: G4 R3_1 )" : tim_up_IRQ }>
...
<#macro curr_sense_ADC motor>
    <#import "R3_1_G4_adc.ftl" as ns_adc >
