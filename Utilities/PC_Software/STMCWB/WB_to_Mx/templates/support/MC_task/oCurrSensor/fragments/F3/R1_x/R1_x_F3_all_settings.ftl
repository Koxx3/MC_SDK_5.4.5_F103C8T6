...
<#macro R1_x_F3_all_settings motor device sense>
...
<#macro curr_sense_TIMER motor>
    ...
    <#import "R1_x_F3_pwm_timer.ftl" as tmr >
...
-->
    <#local table = {"TIM1" : [ {"dma_request": "TIM1_CH4/TRIG/COM", "channel": "DMA1_Channel4" } + dma_req_extra_fields(0)
                              , {"dma_request": "TIM1_UP"          , "channel": "DMA1_Channel5" } + dma_req_extra_fields(1)
                              ]
...
<#macro curr_sense_OPAMP_and_ADC motor>
    <#import "R1_x_F3_opamp.ftl" as op >
...
<#macro curr_sense_ADC motor internal_opamp=false>
    <#import "R1_x_F3_adc.ftl" as ns_adc >
