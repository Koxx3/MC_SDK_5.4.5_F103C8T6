...
-->
    ...
    <#local attr = cr.cortexPinAttribute(pinName)>
    ...
    <#return (
        ...
        , "${pinName}.GPIOParameters=GPIO_Label${attr.cortexLabel}"
...
<#function csf_pin_GPIO pin_def >
    ...
    <#else>
        ...
        <#import "../../Cortex/cortex_utils.ftl" as cr  >
        <#local attr = cr.cortexPinAttribute(pin_def.name)>

        <#return (
            [ "${ ui._left_comment_line( comment ) }"
            , "${pin_def.name}.GPIOParameters=GPIO_Label${attr.cortexLabel}"
